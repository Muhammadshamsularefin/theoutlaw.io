...
define( 'MYOUR_EXTRA_PLUGINS_DIRECTORY', 'https://beshley.com/plugins-latest/myour/' );
define( 'MYOUR_EXTRA_PLUGINS_PREFIX', 'Myour' );
...
if ( ! function_exists( 'myour_setup' ) ) :
	...
	function myour_setup() {
		...
		// Image Sizes
		add_image_size( 'myour_140x140', 280, 280, true );
		add_image_size( 'myour_256x256', 512, 512, false );
		add_image_size( 'myour_680x680', 1360, 1360, true );
...
function myour_stylesheets() {
	...
	wp_enqueue_style( 'myour-fontawesome', get_template_directory_uri() . '/assets/fonts/font-awesome/css/all.min.css', '1.0' );
	wp_enqueue_style( 'myour-style', get_stylesheet_uri(), array( 'magnific-popup', 'animate', 'jarallax', 'owl-carousel', 'swiper', 'myour-fontawesome' ) );
}
